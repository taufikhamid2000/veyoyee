      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:items-center">
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white text-sm w-full sm:w-80 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        >
