-- Migration: Add survey_id column as UUID to veyoyee.marketplace and set up foreign key
...
-- UPDATE veyoyee.marketplace SET survey_id = id::uuid WHERE survey_id IS NULL AND id ~* '^[0-9a-fA-F-]{36}$';
